...
Característica:
  ...
  Escenario:   contactar por la pagina
    Cuando el usario esta en inicio da click en la opcion contacto
    Y el usario entra a contacto llena los campos y le da enviar
  ...
  Escenario: contactar por la pagina datos incorrectos
    Cuando  : el usario esta en inicio da click en la opcion contacto
    Y el usario entra a contato llena los campos y coloca el correo errado
